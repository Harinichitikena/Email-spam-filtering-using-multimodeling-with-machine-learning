...
➤ This project focuses on building a **machine learning-based email spam detection system** that classifies emails as **Spam or Not Spam (Ham)**.

➤ The system uses **multiple machine learning models (multimodeling)** to improve prediction accuracy and evaluate the performance of different algorithms.
